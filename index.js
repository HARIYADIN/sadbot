...
// SILAHKAN EDIT JANGAN LUPA WEEM NYA JAN DIHAPUS
...
setInterval(function () {
  for (i = 0; i < 3; i++) {
    console.log(`[ ${moment().format("HH:mm:ss")} ] => RAMLAN GANS`)
  }
}, 15000)
// Bismillah dulu tod
...
//STICKER
  if (text.includes('!Stiker')) {
    conn.sendMessage(id, 'Kirim gambar dengan caption .stiker um!', MessageType.text, { quoted: m });
  }
